...
public class Coffeeshope {
    ...
    public Coffeeshope(int tea, int sweetPorotta, int cake, int juice, int iceCream) {
        this.tea = tea;
    ...
    public static void main(String[] args) {
        ...
        Coffeeshope food = new Coffeeshope(10, 15, 20, 10, 25);
        Coffeeshope takeaway = new Coffeeshope(15, 20, 25, 15, 30);
        int y;
